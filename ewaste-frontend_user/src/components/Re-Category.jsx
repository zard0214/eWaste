...
export default function Re_Category() {
    ...
    return (
        <div className="container text-center">
                ...
                {brands.slice(0, 5).map(brand=> (
                    <div className="col-md-2 mt-1">
                        <div className="card d-flex flex-column align-items-center justify-content-center"
                            ...
                            <div className="d-flex flex-column justify-content-center" style={{height: '200px', maxWidth:'200px'}}>
                                <img src={brand.imageUrl} className="mx-5 my-2" style={{maxWidth: '100%', height: 'auto', maxHeight:'100%'}}
                                     alt={brand.id}/>
                            </div>
            ...
            <div className="row mt-5 justify-content-center">
                <button className="btn btn-light btn-block col-10" onClick={handleMoreBrandsClick}>
                    <h3>Show more brands</h3>
                </button>
            </div>
        </div>
    );
