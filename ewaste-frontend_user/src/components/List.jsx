...
const List = ({products}) =>{
    ...
    return (
        <div className="container text-center py-4">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 mt-3">
                        <div className="card d-flex flex-column justify-content-center"
                            ...
                            <div className="d-flex flex-column justify-content-center mt-2 mb-2"
                                ...
                                <img src={product.imageUrl} className="mx-5 my-5"
                                     style={{maxWidth: '100%', height: 'auto'}}
                                     alt={1}/>
                            </div>
                            <div className="card-body">
                                <h4 className="mt-3"><b>{product.seriesName}</b></h4>
                                <p><b>£{product.expectedValue}</b></p>
                                <p className="text-xs mb-1">{product.brandName}</p>
                                <p className="text-xs mb-1">capacity: {product.capacity}</p>
                                <p className="text-xs mb-1">condition: {getConditionText(product.condition)}</p>
                            </div>
                        </div>
                    </div>
            ...
            <ul className="pagination mt-5" style={{position: 'absolute', bottom: '0'}}>
            {PageNumbers()}
            </ul>
        </div>
    );
